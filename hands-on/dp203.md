...
## HandsOn Labs
### Lab07: Query data in files - Use SQL to query CSV files
```sql
SELECT
    TOP 100 *
FROM
...
### Lab08: Query data in files - Use SQL to query Parquet files
```sql
SELECT
    TOP 100 *
FROM
...
### Lab09: Query data in files - Use SQL to query JSON files
```sql
SELECT
    TOP 100 *
FROM
